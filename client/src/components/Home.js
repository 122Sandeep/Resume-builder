                ...
                <div className="row">
                    <div className="col-10 mx-auto">
                        ...
                        <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                            ...
                            <h2 className="my-3">This project is designed by Sandeep Dey</h2>
                            <div className="mt-3">
                            ...
                            <div className="col-lg6 order-1 order-lg-2 header-img">
                                <img src="https://th.bing.com/th/id/OIP.7AIejuiwA-wDvbvt_E0jzgHaIu?w=185&h=218&c=7&o=5&dpr=1.5&pid=1.7" className="img-fluid animated" alt="home img"></img>
                            </div>
                            </div> 
